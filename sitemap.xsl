  ...
  <xsl:template match="/">
    <html>
      <head>
        ...
        <link href="/sites/all/modules/xmlsitemap/xsl/xmlsitemap.xsl.css" type="text/css" rel="stylesheet"/>
        <script src="/sites/all/modules/xmlsitemap/xsl/xmlsitemap.xsl.js"></script>
      </head>
